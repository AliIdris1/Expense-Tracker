...
const Income = () => {
  ...
  const handleAddIncome = async (Income) => {
    ...
    //Validate checks
    if(!source.trim()) {
      toast.error("Soorce is Required.")
      return;
    }
  ...
  const handleDownloadIncomeDetails = async () => {
    try {
      ...
      toast.error("Faild to download income details. Pleas try again later.")
    }
  }
    ...
    <Dashboardlayout activeMenu="Income">
      <div className='my-5 mx-auto'>
        <div className='grid grid-cols-1 gap-6 '>
          ...
          <IncomeList transaction={incomeData} onDelete={(id) => {setOpenDeleteAlert({show:true, data:id})}} onDownload={handleDownloadIncomeDetails} />
        </div>
